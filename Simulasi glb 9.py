...
# Lintasan maksimum mobil (m)
max_meter = 90
# Skala pixel per meter
scale_px = 10
# Lebar simulasi
sim_width = max_meter * scale_px  # 900 px
...
#simulasi {{ position: relative; width: {sim_width}px; height: 300px; margin: 30px auto; 
...
<div id="simulasi">
  ...
  <script>
    ...
    const totalGedung=Math.floor({sim_width}/32); // jumlah gedung otomatis berdasarkan lebar simulasi
